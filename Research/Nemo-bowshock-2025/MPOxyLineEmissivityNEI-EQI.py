...
def compute_emissivity(workerQ, doneQ, timeout=0.1):
    ...
    while True:
        try:
            ...
            logger.debug("Computing emissivity for %s lines", ion_name)
            ...
            logger.debug("Finished computing emissivity for %s lines", ion_name)
...
if __name__ == "__main__":
    ...
    for step, (neq_silo, ieq_silo) in enumerate(zip(neq_batched_silos, ieq_batched_silos)):
        ...
        neq_nion = neq_nemo.get_ion_number_density(ion, neq_silo)
        ...
        ieq_nion = ieq_nemo.get_ion_number_density(ion, ieq_silo)
