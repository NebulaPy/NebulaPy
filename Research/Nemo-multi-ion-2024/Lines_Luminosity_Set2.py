...
N3P_line_emission = nebula.line_emission(N3P_pion_ion)  # Initialize the emission line calculation
O3P_line_emission = nebula.line_emission(O3P_pion_ion)  # Initialize the emission line calculation
O5P_line_emission = nebula.line_emission(O5P_pion_ion)  # Initialize the emission line calculation
...
for step, silo_instant in enumerate(batched_silos):
    ...
    N3P_massfrac = nemo.get_ion_values(N3P_pion_ion, silo_instant)  # Retrieve ion mass fraction
